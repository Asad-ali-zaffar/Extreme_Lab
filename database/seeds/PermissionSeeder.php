...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //reporting
        $reporting_module=Module::Create([
            'name'=>'Active Patient Report'
        ]);

        Permission::insert(
            [
                [
                    'module_id'=>$reporting_module['id'],
                    'key'=>'view_reporting',
                    'name'=>'View'
                ]
            ]
        ...
        Permission::insert(
            [
                [
                    'module_id'=>$reporting_module['id'],
                    'key'=>'view_inactive_patient_reporting',
                    'name'=>'View'
                ]
            ]
        );
