...
class GroupsCreditsController extends Controller
{
     /**
     * assign roles
     */
    ...
    {
        return view('admin.groups_credits.index');
    }
    ...
    */
    public function ajax(Request $request)
    {
        ...
        ->editColumn('due',function($group){
            return view('admin.groups_credits._due',compact('group'));
        })
        ->editColumn('done',function($group){
            return view('admin.groups_credits._status',compact('group'));
        })
        ->addColumn('action',function($group){
            return view('admin.groups_credits._action',compact('group'));
        })
        ->toJson();
    }
    ...
    public function create()
    {
        ...
        return view('admin.groups_credits.create',compact('data'));
    }
    ...
    public function store(GroupRequest $request)
    {
       ...
       return redirect()->route('admin.groups_credits.show',$group['id']);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.groups_credits.show',compact('group'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.groups_credits.edit',compact('group','tests','cultures','branches','data'));
    }
    ...
    public function update(GroupRequest $request, $id)
    {
        ...
        return redirect()->route('admin.groups_credits.show',$id);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.groups_credits.index');
    }
