...
use App\Http\Requests\Admin\CustomerRegistrationPriceListDiscountRequest;
...
use Excel;
use DB;
class CustomerRegistrationPriceListDiscountController extends Controller
{
    /**
     * assign roles
     */
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CustomerRegistrationPriceListDiscountRequest $request)
    {
		
        $patient=CustomerRegistrationPriceListsDiscount::create([
            'test_id'=>$request->test_id,
            'cust_price_list_id'=>$request->cust_price_list_id,
    ...
    public function edit($id)
    {
		...
		$data['price_list']= CustomerRegistrationPriceListsDiscount::where('cust_price_list_id',$id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CustomerRegistrationPriceListDiscountRequest $request, $id)
    {
        $patient=CustomerRegistrationPriceList::findOrFail($id);
