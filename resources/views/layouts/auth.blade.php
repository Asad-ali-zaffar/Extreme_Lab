...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{url('public/assets/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
@if(session('rtl'))
	<link rel="stylesheet" href="{{ url('public/assets/css/auth-rtl.css')}}">
@endif
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-more" style="background-color:#021c60;">
				</div>
				...
				<div class="login100-form">
					...
					<span class="login100-form-title p-b-30">
						<img src="{{url('public/img/logo.png')}}" height="100">
					</span>
	...
	<script src="{{url('public/assets/vendor/bootstrap/js/popper.min.js')}}"></script>
