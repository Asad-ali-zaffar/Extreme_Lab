    ...
    <div class="col-lg-4">
       <div class="form-group">
        <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="{{__('Discount Role Id')}}" name="id" id="id" @if(isset($patient)) value="{{$patient->id}}" @endif readonly>
        </div>
       </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{__('Percentage *')}}" name="discount_perct" id="discount_perct" @if(isset($patient)) value="{{$patient->discount_perct}}" @endif required>
                </div>
            </div>
        </div>
    </div>
