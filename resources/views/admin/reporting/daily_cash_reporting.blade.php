            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{__('Daily Activity Cash Report')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">{{__('Daily Activity Cash Report')}}</h3>
            <a href="{{route('admin.reporting.daily_cash_reporting')}}?download=1">
                    ...
                    <div id="collapseOne" class="panel-collapse in collapse">
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-12">
                                    <form action="{{route('admin.reporting.daily_cash_reporting')}}"
                                          class="filter_form">
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                {{--<div class="form-group">
                                                    <label for="filter_bill_type">{{__('Bill Type')}}</label>
                                                    <select name="filter_bill_type" id="filter_bill_type" class="form-control select2">
                                                        <option disabled selected>{{__('Select Bill Type')}}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-primary download_pdf" data-url="{{route('admin.reporting.daily_cash_reporting')}}?download=1">Download Data By Filters (as PDF)
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
