...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">{{__('Organizations Table')}}</h3>
      @can('create_patient')
      <a href="{{route('admin.organizations.create')}}" class="btn btn-primary btn-sm float-right">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 text-center">
                      <a class="btn btn-success" href="{{route('admin.organizations.export')}}">
                        <i class="fa fa-file-excel"></i>
                        {{__('Export')}}
                      </a>
                      <a class="btn btn-success" href="{{route('admin.organizations.download_template')}}">
                        <i class="fa fa-file-excel"></i>
