...
@section('css')
  ...
  <!-- Switch -->
  <link rel="stylesheet" href="{{url('public/plugins/swtich-netliva/css/netliva_switch.css')}}">
@endsection
                                    ...
                                    <div class="card card-primary">
                                      ...
                                      <div class="card-body">
                                        <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                            <div class="form-group">
                                              <label for="">{{__('Upload report header')}} ( {{__('Extension')}}: jpg )</label>
                                              <div class="input-group">
                                                <div class="custom-file">
                                    ...
                                    <div class="card card-primary">
                                      ...
                                      <div class="card-body">
                                        <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                            <div class="form-group">
                                              <label for="">{{__('Upload report background')}} ( {{__('Extension')}}: png )</label>
                                              <div class="input-group">
                                                <div class="custom-file">
                                    ...
                                    <div class="card card-primary">
                                      ...
                                      <div class="card-body">
                                        <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                            <div class="form-group">
                                              <label for="">{{__('Upload report footer')}} ( {{__('Extension')}}: .jpg )</label>
                                              <div class="input-group">
                                                <div class="custom-file">
...
@section('scripts')
    ...
    <script src="{{url('public/plugins/ekko-lightbox/ekko-lightbox.js')}}"></script>
