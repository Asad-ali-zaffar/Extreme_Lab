...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">{{__('Customer Registrations Table')}}</h3>
      @can('create_patient')
      <a href="{{route('admin.customer_registration.create')}}" class="btn btn-primary btn-sm float-right">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 text-center">
                      <a class="btn btn-success" href="{{route('admin.customer_registration.export')}}">
                        <i class="fa fa-file-excel"></i>
                        {{__('Export')}}
                      </a>
                      <a class="btn btn-success" href="{{route('admin.customer_registration.download_template')}}">
                        <i class="fa fa-file-excel"></i>
                    ...
                    <div class="col-lg-12">
                      <!-- import form -->
                      <form action="{{route('admin.customer_registration.import')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mt-3">
                          <div class="col-lg-12">
