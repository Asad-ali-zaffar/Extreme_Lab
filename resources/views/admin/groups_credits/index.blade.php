...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">{{__('Credits Sales/Invoices Table')}}</h3>
      <a href="{{route('admin.groups_credits.create')}}" class="btn btn-primary btn-sm float-right">
  ...
  @include('admin.groups_credits.modals.print_barcode')

@endsection
@section('scripts')
   <script src="{{url('public/js/select2.js')}}"></script>
   <script src="{{url('public/js/admin/groups_credits.js')}}"></script>
@endsection