        ...
        <div class="row">
			...
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    ...
                    <input class="form-control" name="passport_no" id="passport_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['passport_no']}}" @endif>
                </div> 
            </div>
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    <label>{{__('Expiry Date')}}</label>
                    <input class="form-control datepicker" name="exp_date" id="exp_date" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['exp_date']}}" @endif >
                </div> 
            </div>
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    <label>{{__('Flight No')}}</label>
                    <input class="form-control" name="flight_no" id="flight_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['flight_no']}}" @endif>
                </div> 
            </div>
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    <label>{{__('PNR No')}}</label>
                    <input class="form-control" name="pnr_no"  id="pnr_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['pnr_no']}}" @endif >
                </div> 
            </div>
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    <label>{{__('Travelling Date')}}</label>
                    <input class="form-control datepicker" id="trav_date" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['trav_date']}}" @endif >
                </div> 
            </div>
			<div class="col-lg-3 showTravDiv">
                <div class="form-group">
                    ...
                    <select id="airline_id" name="airline_id" class="form-control select2">
						 @foreach($data['airlines'] as $single)
							 <option value="{{$single['id']}}">{{$single['name_eng']}}</option>
						 @endforeach
                ...
                <div class="form-group">
                    ...
                    <select id="dest_count_id" name="dest_count_id" class="form-control select2">
						 @foreach($data['countries'] as $single)
							 <option value="{{$single['id']}}">{{$single['eng_country_name']}}</option>
						 @endforeach
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group labelSize">
							<label class="radio-inline">
							  <input type="radio" name="walk_in_or_cash" value="Walk In" checked> Walk In
							</label>
							
							<label class="radio-inline" style="margin-left: 20px;">
							  <input type="radio" name="walk_in_or_cash" value="Cash Customer"> Cash Customer
							</label>
						</div> 
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input class="form-control" name="lab_no" id="lab_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['lab_no']}}" @endif  >
						</div> 
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<select id="org_id" name="org_id" class="form-control select2" required>
								@foreach($data['organizations'] as $single)
									<option value="{{$single['id']}}" selected>{{$single['name_eng']}}</option>
								@endforeach
							</select>
						</div> 
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input class="form-control" id="inv_no" name="inv_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['inv_no']}}" @endif >
						</div> 
					</div>
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<input class="form-control" name="case_no" id="case_no" @if(isset($group)&&isset($group['patient'])) value="{{$group['patient']['case_no']}}" @endif  >
						</div> 
					</div>
					<div class="col-lg-6">
						<div class="form-group">
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <a href="{{route('admin.groups_credits.index')}}" class="btn btn-danger form-control">{{__('Cancel')}}</a>
    </div>
</div>
