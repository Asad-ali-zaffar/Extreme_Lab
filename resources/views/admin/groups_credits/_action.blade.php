<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
       ...
       @can('edit_group')
          <a href="{{route('admin.groups_credits.edit',$group['id'])}}" class="dropdown-item">
       ...
       @can('view_group')
         ...
         <a href="{{route('admin.groups_credits.show',$group['id'])}}" class="dropdown-item">
         ...
         <form action="{{route('admin.groups_credits.send_receipt_mail',$group['id'])}}" method="POST" class="d-inline">
            @csrf
       ...
       @can('delete_group')
          <form method="POST" action="{{route('admin.groups_credits.destroy',$group['id'])}}" class="d-inline">
