...
<div class="card card-primary card-outline">
    <div class="card-header">
      ...
      @can('create_patient')
      <a href="{{route('admin.departments.create')}}" class="btn btn-primary btn-sm float-right">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 text-center">
                      <a class="btn btn-success" href="{{route('admin.departments.export')}}">
                        <i class="fa fa-file-excel"></i>
                        {{__('Export')}}
                      </a>
                      <a class="btn btn-success" href="{{route('admin.departments.download_template')}}">
                        <i class="fa fa-file-excel"></i>
...
@endsection
@section('scripts')
  <script src="{{url('public/js/admin/department.js')}}"></script>
@endsection
