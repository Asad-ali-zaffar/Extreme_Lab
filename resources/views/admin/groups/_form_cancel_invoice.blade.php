...
<!-- Patient Info -->
 <div class="card card-primary">
    <div class="card-header row">
        <h3 class="col-lg-6 card-title">
            {{__('Patient Info')}}
        </h3>
		
		<div class="col-lg-6">
		  <div class="">
			<input type="hidden" id="hidden_id" name="hidden_id"  @if(isset($group)&&isset($group['id'])) value="{{$group['id']}}" @endif>
			
			 <input type="text" @if(isset($group)&&isset($group['inv_no'])) value="{{$group['inv_no']}}" @endif  name="inv_no" style="padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #495057; background-color: #fff; background-clip: padding-box; border: 1px solid #ced4da; border-radius: 0.25rem; box-shadow: inset 0 0 0 transparent; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out; width: 100%;" id="inv_no" placeholder="{{__('Search with Invoice No')}}">
		  </div>
		</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="col-lg-12">
		  <div class="">
			 <input type="text" name="inv_reason" style="margin: 10px; padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #495057; background-color: #fff; background-clip: padding-box; border: 1px solid #ced4da; border-radius: 0.25rem; box-shadow: 0px 0px 8px #d42428; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out; width: 100%;" id="inv_no" placeholder="{{__('Please type reason')}}">
		  </div>
		</div>
		<div class="col-lg-3"></div>
		
        <button type="submit" class="btn btn-primary" style="width: 100%;">{{__('Request for cancel')}}</button>
    </div>
</div>
