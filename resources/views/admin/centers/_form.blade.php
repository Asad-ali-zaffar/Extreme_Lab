    ...
    <div class="col-lg-4">
       <div class="form-group">
        <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="{{__('Center Id')}}" name="id" id="id" @if(isset($patient)) value="{{$patient->id}}" @endif readonly>
        </div>
       </div>
    </div>
	<div class="col-lg-4">
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <select class="form-control" name="is_active" placeholder="{{__('Status *')}}" id="is_active" required>
