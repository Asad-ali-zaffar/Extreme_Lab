        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <select class="form-control" onchange="serviceChange()" name="patient_type" placeholder="{{__('Patient Type')}}" id="patient_type">
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control datepicker" placeholder="{{__('Date of birth *')}}" name="dob" id="dob" @if(isset($patient)) value="{{$patient['dob']}}" @endif required readonly>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{__('Age Year')}}" name="age_year"  @if(isset($patient)) value="{{$data['interval']->y}} Years" @endif readonly>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{__('Age Month')}}" name="age_month"  @if(isset($patient)) value="{{$data['interval']->m}} Months" @endif readonly>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{__('Age Days')}}" name="age_days"  @if(isset($patient)) value="{{$data['interval']->d}} Days" @endif readonly>
                </div>
            </div>
        </div>
    </div>
	<!------ Add Custom ------->
    <div class="col-lg-3 display_tr">
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <select class="form-control" name="religion" placeholder="{{__('Religion')}}" id="religion" required>
                        <option value="" disabled selected>{{__('Select Religion *')}}</option>
                        <option value="muslim"  @if(isset($patient)&&$patient['religion']=='muslim') selected @endif>{{__('Muslim')}}</option>
                        <option value="other"  @if(isset($patient)&&$patient['religion']=='other') selected @endif>{{__('Other')}}</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" placeholder="{{__('PASSPORT NO')}}" name="passport_no" @if(isset($patient)) value="{{$patient['passport_no']}}" @endif>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control datepicker" placeholder="{{__('Expiry Date')}}" name="ex_date" @if(isset($patient)) value="{{$patient['ex_date']}}" @endif>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <select class="form-control" name="blood_group" placeholder="{{__('Blood Group')}}" id="blood_group" required>
                        <option value="" disabled selected>{{__('Select Blood Group *')}}</option>
                        <option value="A+"  @if(isset($patient)&&$patient['blood_group']=='A+') selected @endif>{{__('A+')}}</option>
                        <option value="A-"  @if(isset($patient)&&$patient['blood_group']=='A-') selected @endif>{{__('A-')}}</option>
                        <option value="B-"  @if(isset($patient)&&$patient['blood_group']=='B+') selected @endif>{{__('B-')}}</option>
                        <option value="B-"  @if(isset($patient)&&$patient['blood_group']=='B-') selected @endif>{{__('B-')}}</option>
                        <option value="AB+"  @if(isset($patient)&&$patient['blood_group']=='AB+') selected @endif>{{__('AB+')}}</option>
                        <option value="AB-"  @if(isset($patient)&&$patient['blood_group']=='AB-') selected @endif>{{__('AB-')}}</option>
                        <option value="O+"  @if(isset($patient)&&$patient['blood_group']=='O+') selected @endif>{{__('O+')}}</option>
                        <option value="O-"  @if(isset($patient)&&$patient['blood_group']=='O-') selected @endif>{{__('O-')}}</option>
                    </select>
                </div>
            </div>
