      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{__('Machine')}}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">{{__('Machines Table')}}</h3>
      @can('create_patient')
      <a href="{{route('admin.machine.create')}}" class="btn btn-primary btn-sm float-right">
