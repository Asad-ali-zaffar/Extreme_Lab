...
@section('css')
    <link rel="stylesheet" href="{{url('public/plugins/datetimepicker/css/jquery.datetimepicker.min.css')}}">    
@endsection
...
@endsection
@section('scripts')
    <script src="{{url('public/plugins/datetimepicker/js/jquery.datetimepicker.full.js')}}"></script>
